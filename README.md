...
[![Sonarcloud Coverage](https://sonarcloud.io/api/project_badges/measure?id=de.viadee.ki:spark-importer&metric=coverage)](https://sonarcloud.io/dashboard?id=de.viadee.ki:spark-importer) 
