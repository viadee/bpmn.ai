...
public class KafkaProducerApp {
    ...
    private final static String FILE_STREAM_INPUT_PROCESS_INSTANCE = "./resources/variableUpdate.json";
    private final static String FILE_STREAM_INPUT_VARIABLE_UPDATE = "./resources/processInstance.json";
